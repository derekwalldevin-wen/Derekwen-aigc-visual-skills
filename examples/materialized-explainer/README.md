...
The source planning sheet and output model share the same four-stage flow: 输入 → 整理 → 创作 → 输出. The source is itself an AI-generated photograph, not a code-drawn placeholder.
...
[Open the Skill →](../../skills/materialized-explainer/)
